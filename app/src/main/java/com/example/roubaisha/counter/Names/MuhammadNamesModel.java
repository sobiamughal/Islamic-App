...
public class MuhammadNamesModel {
    String banName;
    String enName;
    String  bannglamean;
    String  englishmean;
    ...
    public MuhammadNamesModel(String banName, String enName) {
        this.banName = banName;
        this.enName = enName;
    }

    public MuhammadNamesModel(String banName, String enName, String  bannglamean,String  englishmean,int mp3File) {
        this.banName = banName;
        this.enName = enName;
